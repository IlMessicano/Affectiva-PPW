...
<div class="container-fluid">
    ...
    <div class="row" style="margin: 1%">
        ...
        <div class="col-md-6" style="padding: 1%; border: 1px solid black">
            <label style="width: 100%"><b>Task:</b> {{$data->nomeTask}}</label>
    ...
    <div class="row" style="margin: 1%">
        <div class="col-md-6" style="padding: 1%; border: 1px solid black">
            <label style="width: 100%"><b>Video: </b>@forelse($Video as $Video) {{$Video->nomeVideo}} | @empty novideo @endforelse</label>
        </div>
    </div>
</div>
