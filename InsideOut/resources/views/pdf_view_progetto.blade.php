...
<div class="container-fluid">
    ...
    <div class="row" style="margin: 1%">
        <div class="col-md-6" style="padding: 2%; border: 1px solid black">
            <label style="width: 100%"><b>Progetto:</b> {{$data->nome}}</label>
            <label style="width: 100%"><b>Descrizione:</b> {{$data->descrizione}}</label>
        </div>

        <div class="col-md-6" style="padding: 1%; border: 1px solid black">
            <label style="width: 100%"><b>Task:</b>@forelse($Task as $task) {{$task->nomeTask}} | @empty no task @endforelse</label>
        </div>
    </div>

    <div class="row" style="margin: 1%">
        <div class="col-md-6" style="padding: 1%; border: 1px solid black">
            <label style="width: 100%"><b>Video: </b>@forelse($Task as $task)  <?php $Video = \App\Http\Controllers\VideoController::getVideo($task->id) ?> @forelse($Video as $video) {{$video->nomeVideo}} |  @empty no video @endforelse @empty no task @endforelse</label>
        </div>
    </div>
</div>
